    ...
    public function AddToCompare(Request $request,$property_id){
        if(Auth::check()){
            ...
            if(!$exists){
                ...
                return response()->json(['success'=>'Successfullly Added On Your Compare']);
            }else{
                return response()->json(['error'=>'This Property has alreday in your CompareList']);
            }
        }else{
        ...
        public function CompareRemove($id){
            ...
            return response()->json(['success'=>'Successfully Remove Compare']);
        }
    }
