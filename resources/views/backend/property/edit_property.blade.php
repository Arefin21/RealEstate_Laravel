            ...
            <div class="col-sm-3">
                <div class="mb-3">
                    ...
                    <select name="state" class="form-select" id="exampleFormControlSelect1">
                        ...
                        @foreach ($pState as $item )
                            
                        <option value="{{$item->id}}" {{$item->id==$property->state ? 'selected':''}}>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="mb-3">
                    ...
                    target="_blank">Go here to 
                    get Latitude from Address</a>
                </div>
            </div><!-- Col -->
            <div class="col-sm-6">
                <div class="mb-3">
            ...
            <div class="col-sm-4">
                <div class="mb-3">
                    ...
                    <select name="amenities_id[]" class="js-example-basic-multiple form-select" multiple="multiple" data-width="100%">
                        ...
                        <option value="{{$amenitie->amenitis_name}}"{{(in_array($amenitie->amenitis_name,$property_ame))?'selected':''}}>
                            {{$amenitie->amenitis_name}}</option>
                        @endforeach
...
{{-- //Property Mian Thambnail Image Update --}}
            ...
            <form method="post" action="{{route('update.property.thambnail')}}" id="myForm" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="form-group col-md-6">
                        ...
                        <input type="file" name="property_thambnail" class="
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <img src="{{asset($property->property_thambnail)}}" 
                         style="width:100px; heoght:100px " alt="">
                    </div>
                </div>
...
{{-- //End Property Mian Thambnail Image Update --}}
...
<div class="page-content" style="margin-top: -35px;">
    <div class="row profile-body">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                @foreach ($multImage as $key => $img)
                    
                <tr>
                    <td>{{$key+1}}</td>
                    <td class="py-1">
                        <img src="{{asset($img->photo_name)}}" alt="" style="width: 50px; height:50px;">
                    </td>
                    <td>
                        <input type="file" class="form-control" name="multi_img[{{$img->id}}]">
                    </td>
                    <td>
                        <input type="submit" class="btn btn-primary px-4" value="Update Image" name="multi_img">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <input type="submit" class="btn btn-info px-4" name="" value="Add Image">
                    </td>
                </tr>
                </tbody>
            </table> 
        ...
        <div class="card">
            ...
            <form method="post" action="{{route('update.property.facilities')}}" id="myForm" enctype="multipart/form-data">
                ...
                <div class="whole_extra_item_delete" id="whole_extra_item_delete">
                    ...
                    <option value="SuperMarket"{{$item->facility_name=='SuperMarket' ? 'selected' : ''}}>SuperMarket</option>
