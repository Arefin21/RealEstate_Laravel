...
<section class="property-details property-details-one">
    <div class="auto-container">
        ...
        <figure class="author-thumb"><img src="{{ url('upload/b.jpg')}}" alt=""></figure>
        <h6>Admin</h6>
        ...
        <div class="carousel-inner">
            <div class="single-item-carousel owl-carousel owl-theme owl-dots-none">
                ...
                <figure class="image-box"><img 
                    src="{{asset($img->photo_name)}}" alt=""></figure>
...
@foreach ($facility as $item )
                            <div class="box clearfix">
                                <div class="text pull-left">
                                    <h6>{{ $item->facility_name }}<span>({{ $item->distance}} )</span></h6>
                                </div>
                            ...
                            <div class="lower-content">
                                <div class="author-info clearfix">
                                    ...
                                    @if ($item->agent_id==NULL)
                                        ...
                                        src="{{ url('upload/b.jpg')}}" alt=""></figure>
                                        <h6>Admin</h6>
                                    @else 
                                        <figure class="author-thumb"><img src="{{(!empty($item->user->photo))?
                                        url('upload/agent_images/'.$item->user->photo):
                                        url('upload/no_image.jpg')}}" alt=""></figure>
