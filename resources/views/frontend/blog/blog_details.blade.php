    ...
    <div class="inner-box">
        ...
        <div class="lower-content">
            ...
            <ul class="post-info clearfix">
                <li class="author-box">
                    <figure class="author-thumb"><img src="{{asset(!empty($blog->user->photo))?url('upload/admin_images/'.$blog->user->photo):url('upload/no_image.jpg')}}" alt=""></figure>
...
@endphp
        ...
        <div class="comment">
            <figure class="thumb-box">
                <img src="{{(!empty($cmnt->user->photo))?url('upload/user_images/'.$cmnt->user->photo):
                url('upload/no_image.jpg')}}" alt="">
            </figure>
            <div class="comment-inner">
                <div class="comment-info clearfix">
                    <h5>{{$cmnt->user->name}}</h5>
                    <span>{{$cmnt->created_at->format('M d Y')}}</span>
                </div>
                <div class="text">
                    <p>{{$cmnt->subject}} </p>
                    <p>{{$cmnt->message}} </p>
...
@php
    $reply=App\Models\Comment::where('parent_id',$cmnt->id)->get();
@endphp
...
<input type="hidden" name="post_id" value="{{$blog->id}}">
    ...
    @else
        <p><b>For Add Comment You Need To Login First 
