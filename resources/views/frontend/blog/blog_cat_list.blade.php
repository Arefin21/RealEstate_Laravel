...
<section class="page-title-two bg-color-1 centred">
    ...
    <div class="auto-container">
        <div class="content-box clearfix">
            <h1>{{$cname->catagory_name}}</h1>
            <ul class="bread-crumb clearfix">
                <li><a href="index.html">{{$cname->catagory_name}}</a></li>
                <li></li>
            </ul>
        </div>
    </div>
        ...
        <div class="lower-content">
            ...
            <ul class="post-info clearfix">
                <li class="author-box">
                    ...
                    src="{{asset(!empty($item->user->photo))?url('upload/admin_images/'.$item->user->photo):
                    url('upload/no_images.jpg')}}" alt=""></figure>
