      ...
      <table id="dataTableExample" class="table">
        ...
        @foreach ($property as $key=>$item )
          ...
          <tr>
            ...
            <td>
              <a href="{{route('agent.details.property',$item->id)}}" class="btn btn-inverse-info" id="details" title="Details"><i data-feather="eye"></i></a> 
              <a href="{{route('agent.edit.property',$item->id)}}" class="btn btn-inverse-warning" id="edit" title="Edit"><i data-feather="edit"></i></a>  
